            ...
            <main style={{ padding: '20px 16px', maxWidth: '1100px', margin: '0 auto' }}>
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <p style={{ color: '#9aa0b4', margin: 0, fontSize: '14px' }}>
                        {total} total — <span style={{ color: '#f7c137' }}>{featuredCount} featured</span>
                    </p>
                </div>
                    ...
                    <>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '24px', flexWrap: 'wrap', gap: '12px' }}>
                            ...
                            <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                ...
                                <span style={{ background: '#f7c137', color: '#0a0f1e', padding: '8px 16px', borderRadius: '8px', fontSize: '14px', fontWeight: 700 }}>
