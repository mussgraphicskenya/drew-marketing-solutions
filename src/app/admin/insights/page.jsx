        ...
        <div style={{ minHeight: '100vh', background: '#0a0f1e', color: '#e0e4f0', fontFamily: 'system-ui, sans-serif' }}>
            ...
            <main style={{ padding: '20px 16px', maxWidth: '1100px', margin: '0 auto' }}>
                <div style={{ marginBottom: '20px' }}>
                    ...
                    <p style={{ color: '#9aa0b4', margin: 0, fontSize: '14px' }}>{items.length} article{items.length !== 1 ? 's' : ''} in the database</p>
                </div>
                                ...
                                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '12px', gap: '12px' }}>
                                    <div style={{ minWidth: 0, flex: 1 }}>
                                        ...
                                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px', alignItems: 'center' }}>
                                            ...
                                            {item.featured && (
                                                <span style={{ color: '#00c48c', fontSize: '12px' }}><i className="bi bi-check-circle-fill me-1"></i>Featured</span>
                                            )}
                                        </div>
                                    </div>
                                    {item.coverImage && (
