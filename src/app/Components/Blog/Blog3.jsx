                            ...
                            <div key={i} className="col-lg-4 col-md-6">
                                <div className="single-blog-box">
                                    <div className="single-blog-thumb">
                                        <Image src={getCloudinaryUrl(item.coverImage, 364, 248) || `https://picsum.photos/seed/blog3-${i + 1}/364/248`} alt={item.title || 'Insight'} width={364} height={248} style={{ width: '100%', height: 'auto', objectFit: 'cover' }} />
                                    </div>
